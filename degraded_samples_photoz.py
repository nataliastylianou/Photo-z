...
plt.scatter(Y_degraded_samples[testing,:][0:100],mu_degraded_samples[0:100],s=5, edgecolor=['none'])
#f.show()
#plt.show()
...
xy = hstack([Y_degraded_samples[testing,:],mu_degraded_samples]).T
z = gaussian_kde(xy)(xy)
plt.scatter(Y_samples[testing,:],mu_samples,s=5, edgecolor=['none'])
plt.scatter(Y_degraded_samples[testing,:],mu_degraded_samples,s=5, edgecolor=['none'])
#c=z
#f.show()
#plt.show()
...
f = plt.figure(3)
plt.plot(x.astype(int),rmse_samples[ind_s-1].astype(int),'o-')
plt.plot(x.astype(int),rmse_degraded_samples[ind_ds-1].astype(int),'o-')
...
centers_ds,means_ds,stds_ds = GPz.bin(Y_degraded_samples[testing],Y_degraded_samples[testing]-mu_degraded_samples,20)
...
centers_ds,means_ds,stds_ds = GPz.bin(Y_degraded_samples[testing],sqrt(modelV_degraded_samples),20)
plt.errorbar(centers_s,means_s,stds_s,fmt='o')
plt.errorbar(centers_ds,means_ds,stds_ds,fmt='o')
plt.xlabel('Spectroscopic Redshift')
...
centers_ds,means_ds,stds_ds = GPz.bin(Y_degraded_samples[testing],sqrt(noiseV_degraded_samples),20)
plt.errorbar(centers_s,means_s,stds_s,fmt='o')
plt.errorbar(centers_ds,means_ds,stds_ds,fmt='o')
plt.xlabel('Spectroscopic Redshift')
