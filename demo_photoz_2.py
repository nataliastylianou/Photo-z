...
maxIter = 5                  # maximum number of iterations [default=200]
...
#f.show()
pb.savefig("/mnt/zfsusers/stylianou/project/figures/fig_1_2.pdf")
...
#f.show()
pb.savefig("/mnt/zfsusers/stylianou/project/figures/fig_2_2.pdf")
