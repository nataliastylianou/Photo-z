...
plt.title('500 iterations - Trained on SDSS samples and Tested on SDSS samples')
#f.show()
#plt.show()
pb.savefig("/mnt/zfsusers/stylianou/project/figures/demo_1.pdf")
...
#f.show()
#plt.show()
pb.savefig("/mnt/zfsusers/stylianou/project/figures/demo_2.pdf")
